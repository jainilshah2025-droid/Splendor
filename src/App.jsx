...
const css=`
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .field input{width:100%;padding:10px 13px;border:1.5px solid #ddd;border-radius:8px;font-family:'Jost',sans-serif;font-size:.85rem;background:#fdfcfa;outline:none;transition:border .15s;color:#1a1a1a;}
